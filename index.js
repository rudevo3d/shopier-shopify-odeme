  ...
  try {
    ...
    if (!API_KEY || !API_SECRET) {
      return res.status(500).json({ 
        ...
        debug: { hasKey: !!API_KEY, hasSecret: !!API_SECRET }
      });
    }
